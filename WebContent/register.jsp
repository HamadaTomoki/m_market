	...
	<div class="login">
		<div class="main-agileits">
			<div class="form-w3agile">
				<h3 style="margin: 0; font-size: 25px; font-weight: bold;">会員登録</h3>
				<hr style="width: 50%;">
				<form action="/m_market/AcountRegister" method="post">
					...
					<div style="text-align: center;">
						<button type="submit" style="width: 60%; font-size: 15px; padding-top: 10px; padding-botttom: 10px;" class="btn btn-danger fb-tag btn-conf mt-4">登録する</button>
					</div>
				</form>
			</div>
		</div>
